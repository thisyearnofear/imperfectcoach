 ...
 *
 * Single source of truth for agent economy:
 * - Agent profile information used in UI
 * - Cost calculations and value comparisons
 * - Processing messages during agent coordination
 *
 * PRINCIPLE: DRY - Single source of truth for all agent profiles
 * PRINCIPLE: CLEAN - Separation of concerns from orchestration logic
 */

import { AgentEconomyProfile, AgentCoordinationResult, ContributionStatus } from './types';
