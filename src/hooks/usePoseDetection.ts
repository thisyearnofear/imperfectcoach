...
import { Exercise, RepData, PoseData, RepState, CoachPersonality, CameraStatus, WorkoutMode } from '@/lib/types';
...
export const usePoseDetection = ({ videoRef, cameraStatus, exercise, onRepCount, onFormFeedback, canvasRef, isDebugMode, onPoseData, onFormScoreUpdate, onNewRepData, coachPersonality, workoutMode }: UsePoseDetectionProps) => {
        ...
        if (poses && poses.length > 0) {
          ...
          switch (exercise) {
            ...
            case 'jumps':
              ...
              if (workoutMode === 'training') onFormFeedback("Jump detection is not yet implemented.");
              break;
          }
        }
      }
  ...
  }, [cameraStatus, videoRef, repState, onRepCount, onFormFeedback, canvasRef, isDebugMode, onPoseData, onFormScoreUpdate, internalReps, onNewRepData, exercise, coachPersonality, playBeep, speak, workoutMode]);
