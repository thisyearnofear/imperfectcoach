...
export function FeatureSpotlight({
  ...
  const { highestPriorityFeature: feature } = useFeatureDiscovery();
  ...
  const getIcon = () => {
    if (feature.id.includes("agent")) return <Brain className="h-5 w-5" />;
    if (feature.id.includes("training")) return <Target className="h-5 w-5" />;
    if (feature.id.includes("analytics")) return <TrendingUp className="h-5 w-5" />;
        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            {feature.priority === "high" ? "High Priority" : 
             feature.priority === "medium" ? "Recommended" : "Available"}
          </Badge>
